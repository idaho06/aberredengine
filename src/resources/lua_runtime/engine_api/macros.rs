    ...
    ($engine:expr, $lua:expr, $meta_fns:expr, $prefix:literal, $queue:ident) => {
        define_cmd_twins!($engine, $lua, $meta_fns, $prefix, $queue, "entity", "", [
            ...
            ("entity_remove_tint", |entity_id| u64, EntityCmd::RemoveTint { entity_id },
                ...
                params = [("entity_id", "integer")]),
            ("entity_set_shadow",
                |(entity_id, dx, dy, r, g, b, a)| (u64, f32, f32, u8, u8, u8, u8),
                EntityCmd::SetShadow { entity_id, dx, dy, r, g, b, a },
                desc = "Set entity drop shadow (offset dx/dy and RGBA color 0-255)",
                params = [("entity_id", "integer"), ("dx", "number"), ("dy", "number"),
                          ("r", "integer"), ("g", "integer"), ("b", "integer"), ("a", "integer")]),
            ("entity_remove_shadow", |entity_id| u64, EntityCmd::RemoveShadow { entity_id },
                desc = "Remove entity shadow",
                params = [("entity_id", "integer")]),
