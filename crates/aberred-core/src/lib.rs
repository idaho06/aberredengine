...
//! dependency tree — that is this crate's whole reason for existing.
//! Render-only, audio-only, and Lua-only code lives in sibling crates
//! (`aberred-render`, `aberred-audio`, `aberred-lua`) / the `aberredengine`
//! facade.
